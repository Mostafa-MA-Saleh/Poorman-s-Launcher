package com.gmail.mostafa.ma.saleh.poormanslauncher.utils
...
class SnapToBlock : SnapHelper() {
    ...
    override fun findSnapView(layoutManager: RecyclerView.LayoutManager): View? {
        ...
        return layoutManager.findViewByPosition(snapPos).takeUnless { snapPos == RecyclerView.NO_POSITION }
    }
    ...
    companion object {
        ...
        fun attachToRecyclerView(recyclerView: RecyclerView?): SnapToBlock =
            SnapToBlock().apply { attachToRecyclerView(recyclerView) }
    }
}